...
var uri = 'mongodb+srv://taylaOrsmond:imyiscool@demo.yqz62w3.mongodb.net/test?authSource=DBExample&authMechanism=SCRAM-SHA-1';
var client = new MongoClient(uri);
require("regenerator-runtime/runtime");
io.on('connection', function (socket) {
  queryClasses().then(function (results) {
    socket.emit('classes', results);
  });
  console.log('Connection successful:');
  socket.on("enrollment", function (code) {
    console.log("Enrollment request received for code: " + code);
    queryUsers(code).then(function (results) {
...
function queryClasses() {
  return _queryClasses.apply(this, arguments);
...
function _queryClasses() {
  _queryClasses = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var db, col, cursor, results;
    ...
    }, _callee, null, [[0, 14, 17, 21]]);
  }));
  return _queryClasses.apply(this, arguments);
}
function queryUsers(_x) {
  return _queryUsers.apply(this, arguments);
}
function _queryUsers() {
  _queryUsers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(code) {
    var db, col, cursor, results;
